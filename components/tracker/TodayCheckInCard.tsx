...
function MetricRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between gap-3 rounded-xl border border-border/50 bg-white/55 px-3 py-2">
...
export function TodayCheckInCard() {
  ...
  const summaryRows = useMemo(() => {
    ...
    if (savedCheckIn.bodyweight) {
      rows.push({ label: "Bodyweight", value: savedCheckIn.bodyweight })
    }
  ...
  return (
    <>
      <Card className="brand-panel border-border/50 shadow-sm">
        <CardHeader className="pb-4">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="meta-pill inline-flex items-center rounded-full px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground">
              Local only
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          {savedCheckIn ? (
            <>
              ...
              {savedCheckIn.notes ? (
                <div className="surface-subtle rounded-2xl border border-border/60 p-3">
                  <div className="mb-1 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground">
                    <NotebookPen className="h-3.5 w-3.5" />
                    Notes
                  </div>
                  <p className="text-sm text-foreground">{savedCheckIn.notes}</p>
                </div>
              ) : null}

              <div className="flex items-center justify-between gap-3 rounded-2xl border border-primary/12 bg-primary/[0.05] px-3.5 py-3 text-sm">
                <span className="text-muted-foreground">
                  Workout completed: <span className="font-semibold text-foreground">{savedCheckIn.workoutCompleted === "yes" ? "Yes" : "No"}</span>
                </span>
              ...
              <Button type="button" variant="outline" className="w-full" onClick={openForCreate}>
            ...
            <div className="space-y-4">
              <div className="surface-subtle rounded-2xl border border-border/60 p-4">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Capture today’s readiness metrics here. This stays local to the browser in Phase 1.
                </p>
              </div>

              <div className="grid gap-2 sm:grid-cols-3">
                <div className="detail-panel flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground">
              ...
              <Button type="button" className="w-full" onClick={openForCreate}>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="surface-card max-w-2xl rounded-[1.6rem] border-border/60 p-0 sm:max-w-2xl">
          <DialogHeader className="border-b border-border/50 px-6 pt-6 pb-5 text-left">
            ...
            <DialogTitle className="pt-3 text-2xl">Log training metrics</DialogTitle>
            <DialogDescription>
              This Phase 1 form is local only. Nothing here writes to Google Sheets, Apps Script, or the workout engine.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 px-6 py-5 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="sleep" className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="soreness" className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="stress" className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="1">1 - Very low</SelectItem>
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              >
                <SelectTrigger id="workout-completed" className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              <Textarea
                ...
                className="control-surface min-h-24"
          ...
          <DialogFooter className="border-t border-border/50 px-6 py-4 sm:justify-between">
            <p className="text-sm text-muted-foreground">Saved only in local React state for this session.</p>
